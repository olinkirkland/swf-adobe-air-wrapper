 ...
 * Example AS3 code:<listing version="3.0">
 ...
 //create a CSSLoader
 var loader:CSSLoader = new CSSLoader("assets.css/styles.assets.css", {name:"myCSS", requireWithRoot:this.root, estimatedBytes:900});
 ...
 */	
	public class CSSLoader extends DataLoader {
		/** @private **/
		private static var _classActivated:Boolean = _activateClass("CSSLoader", CSSLoader, "assets.css");
		
		/**
		 * Constructor
		 * 
		 * @param urlOrRequest The url (<code>String</code>) or <code>URLRequest</code> from which the loader should get its content.
		 * @param vars An object containing optional configuration details. For example: <code>new CSSLoader("assets.css/styles.assets.css", {name:"myCSS", onComplete:completeHandler, onProgress:progressHandler})</code>.
		 * 
